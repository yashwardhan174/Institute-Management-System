...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
                    Welcome to Yashwardhan's Institute Management System
                </h1>
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<li><p>The “Institute Management System” Website (web based application) is useful for the students, faculty, guest who likes to display result as well schedules of examination and all that task like event, news, students can find out list of fresh courses offered by them and admission procedure, discussion forum, fee structure etc. without going to institute.</p></li>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<ul style="list-style-type:disc">
						...
						<li>For done the work easy without time lagging.</li>
						<li>For making accurate records.</li>
						<li>To lead the institute on to a path of flexible work i.e. work from anywhere.<br></li>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Institute Management System</h2>
		</div>
		<div class="col-md-6">
			<p>Institute Management System by <strong>YASHWARDHAN NIGAM</strong> includes:</p>
			<ul>
