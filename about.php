<?php include('allhead.php'); ?>
    ...
    <div class="container" style="max-width: 1200px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h2>ABOUT Institute Management System</h2>
                <p>The <strong>“Institute Management System”</strong> Website (web based application) is useful for the students, faculty, guest who likes to display result as well schedules of examination and all that task like event, news, students can find out list of fresh courses offered by them and admission procedure, discussion forum, fee structure etc. without going to institute. It provides the facility to the students or guest to have complete information about the institute.</p>
                <p>In this website, does not need to perform papers work likes to make result sheet on papers and then put on the notice board. But on this site just go to the database and update the result and other information.</p>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Our Alumni</h2>
            </div>
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <img class="img-responsive" src="images/new/253f9ac.jpg" alt="">
                    <div class="caption">
                        <h3>Reeta Grover<br>
                            <small>Teacher</small>
                        </h3>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <img class="img-responsive" src="images/new/sif10225.225782846266003821356.jpg" alt="">
                    <div class="caption">
                        <h3>Kunal Mathur<br>
                            <small>Teacher</small>
                        </h3>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <img class="img-responsive" src="images/new/Lærer-studerende-på-UCN.jpg" alt="">
                    <div class="caption">
                        <h3>Indrejeet Kaur<br>
                            <small>Teacher</small>
                        </h3>
        ...
        <footer>
                    ...
                    <p class="footer text-center">Copyright &copy; Institute Management System 2017  <strong>BCA</strong> project Made by <strong>VISHAL MATHUR 146891645</strong></p>
